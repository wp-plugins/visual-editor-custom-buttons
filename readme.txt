...
= I have just updated from an earlier version and now the CSS is no longer viewable in the Visual Editor or even worse, the buttons doesn´t show up at all in the Visual Editor.
Why is that? =
